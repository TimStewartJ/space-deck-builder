...
from src.engine.actions import get_available_actions, Action
...
class NeuralAgent(Agent):
    ...
    def decode_action(self, action_idx, available_actions):
        """Convert index to actual action"""
        # Map index back to action
        return available_actions[min(action_idx, len(available_actions)-1)]
